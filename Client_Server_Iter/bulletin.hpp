...
struct BulletInfo{
            ...
            BulletInfo<T> operator=(BulletInfo<T> newbullet){
                name = newbullet.name;
                text = newbullet.text;
                return *this;
            }
...
class db_user: public database{
    ...
    public:
        ...
        int insert(BulletInfo<string>& user);
        ...
        template<hashable T = string, hashable T_input = string>
        vector<T> getBulletinAttributes(vector<pair<string, T_input>> constraints, string target_attribute){
